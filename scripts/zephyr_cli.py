...
DOMAIN_REGISTRY = {
    ...
    'cad-documents':      ('domains.CADDocumentMgmt',    'CADDocumentMgmtClient',    'CADDocuments',       'query_cad_documents',       'get_cad_document_by_number'),
    ...
    'changes':            ('domains.ChangeMgmt',         'ChangeMgmtClient',         'ChangeNotices',      'query_change_notices',      'get_change_notice_by_number'),
    'change-requests':    ('domains.ChangeMgmt',         'ChangeMgmtClient',         'ChangeRequests',     'query_change_requests',     'get_change_request_by_number'),
    'suppliers':          ('domains.SupplierMgmt',       'SupplierMgmtClient',       'Suppliers',          'query_suppliers',           'get_supplier_by_name'),
    'capas':              ('domains.CAPA',               'CAPAClient',               'CAPAs',              'search_capas',              'get_capa_by_number'),
    'qms-capas':          ('domains.QMS',                'QMSClient',                'CAPAs',              'get_capas',                 None),
    ...
    'baselines':          ('domains.BACMgmt',            'BACMgmtClient',            'Baselines',          'get_baselines',             None),
    'containers':         ('domains.DataAdmin',          'DataAdminClient',          'Containers',         'get_containers',            None),
    'folders':            ('domains.DataAdmin',          'DataAdminClient',          'Folders',            'get_folders',               None),
    ...
    'workflows':          ('domains.Workflow',           'WorkflowClient',           'WorkflowProcesses',  'get_workflow_processes',    None),
    'lifecycle-templates': ('domains.Workflow',          'WorkflowClient',           'LifecycleTemplates', 'get_lifecycle_templates',   None),
    'registrations':      ('domains.RegMstr',            'RegMstrClient',            'Registrations',      'get_registrations',         None),
    'udi-records':        ('domains.UDI',                'UDIClient',                'UDIRecords',         'get_udi_records',           None),
    'classifications':    ('domains.ClfStructure',        'ClfStructureClient',       'ClfNodes',           'search_clf_nodes',          None),
    'control-documents':  ('domains.DocumentControl',    'DocumentControlClient',    'ControlDocuments',   'search_control_documents',  'get_control_document_by_number'),
    ...
    'service-docs':       ('domains.ServiceInfoMgmt',    'ServiceInfoMgmtClient',    'ServiceDocuments',   'get_service_documents',     'get_service_document_by_number'),
    'customer-experiences': ('domains.CEM',             'CEMClient',                'CustomerExperiences','get_customer_experiences',  None),
    'process-plans':      ('domains.MfgProcMgmt',        'MfgProcMgmtClient',        'ProcessPlans',       'query_process_plans',       'get_process_plan_by_number'),
