---
Type: Cross-Domain
Use: Base client for generic OData operations
---

> **Cross-Domain Reference**: This documents common patterns across all domains.
>
> For generic OData operations, use: `from windchill_base import WindchillBaseClient`
